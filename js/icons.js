...
export const ICON = {
  ...
  // Edited file(s)：文件 + 笔
  edited: ico('<path d="M14.5 2.5H7A1.5 1.5 0 0 0 5.5 4v16A1.5 1.5 0 0 0 7 21.5h10a1.5 1.5 0 0 0 1.5-1.5V8Z"/><path d="M14 2.8V7a1.5 1.5 0 0 0 1.5 1.5H20"/><path d="M8.2 15.5 12 16.4l.8-3.8 3.7-3.7a1.15 1.15 0 0 0-1.62-1.62L8.2 15.5Z"/>'),
  // 深度思考：与顶栏「思考」胶囊同一组脑形路径，保证视觉语言一致
